            ...
            return (
                ...
                <div className='page'>
                    ...
                    <div className='order-card-div'>
                        ...
                        <OrderHistoryCard color="red" imgSrc='https://images.unsplash.com/photo-1513104890138-7c749659a591?w=120&q=80' resturantName='#0042' date='Oct 24' time='12:45 PM' price='4,500' items='2' status='John Doe' click={() => props.navFunction("resturantorderhistorydetails")} />
                        <OrderHistoryCard color="red" imgSrc='https://images.unsplash.com/photo-1513104890138-7c749659a591?w=120&q=80' resturantName='#0042' date='Oct 24' time='12:45 PM' price='4,500' items='2' status='John Doe' click={() => props.navFunction("resturantorderhistorydetails")} />
                        <OrderHistoryCard color="red" imgSrc='https://images.unsplash.com/photo-1513104890138-7c749659a591?w=120&q=80' resturantName='#0042' date='Oct 24' time='12:45 PM' price='4,500' items='2' status='John Doe' click={() => props.navFunction("resturantorderhistorydetails")} />
                        <OrderHistoryCard color="red" imgSrc='https://images.unsplash.com/photo-1513104890138-7c749659a591?w=120&q=80' resturantName='#0042' date='Oct 24' time='12:45 PM' price='4,500' items='2' status='John Doe' click={() => props.navFunction("resturantorderhistorydetails")} />
                        <OrderHistoryCard color="red" imgSrc='https://images.unsplash.com/photo-1513104890138-7c749659a591?w=120&q=80' resturantName='#0042' date='Oct 24' time='12:45 PM' price='4,500' items='2' status='John Doe' click={() => props.navFunction("resturantorderhistorydetails")} />
